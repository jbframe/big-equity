...
| `simulationAPI` | *Planned* — Fastify HTTP API backend (TypeScript, zod-validated routes); will be the CRUD layer in front of a future private DB container. | [ADR-002](docs/adr/002-fastify-backend-container.md) |
...
| `simulationAPI` | Planned | https://api.makejohnacoffee.com (per [ADR-002](docs/adr/002-fastify-backend-container.md)) |

How the exposure works (see [ADR-001](docs/adr/001-expose-simulationweb.md); the planned API follows the same pattern per [ADR-002](docs/adr/002-fastify-backend-container.md)):
...
graph TD
    ...
    subgraph EC2["AWS EC2 Instance"]
        ...
        subgraph Docker["Docker containers"]
            ...
            API["simulationAPI<br/>Fastify · :3003 · 🚧 planned (ADR-002)"]
    ...
    style API fill:#0c3d1f,stroke:#22c55e,stroke-width:2px,stroke-dasharray:6 4,color:#ffffff
